...
## On-device downloadable LLM (2026-07-24, build 73)
User: Apple Intelligence isn't on every device → add downloadable local LLMs so non-A17-Pro devices get on-device Intelligence too.
