  ...
  if (phase === 'armed') {
    ...
    content = (
      <>
        ...
        {window.ListeningGhost && !isCmd && <span style={{ display: 'flex', margin: '-4px -2px' }}><ListeningGhost phase="idle" size={30} /></span>}
        {isCmd && (
    ...
    content = (
      <>
        {window.ListeningGhost ? <span style={{ display: 'flex', margin: '-4px -2px' }}><ListeningGhost phase="note" size={30} /></span> : <span style={{ width: 16, height: 16, borderRadius: '50%', border: `2px solid ${border}`, borderTopColor: accent, animation: 'wzspin .8s linear infinite' }} />}
